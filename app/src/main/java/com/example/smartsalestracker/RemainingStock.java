...
public class RemainingStock extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_remaining_stock);
        ...
        reportAdapter = new ReportAdapter(RemainingStock.this, productArrayList);
