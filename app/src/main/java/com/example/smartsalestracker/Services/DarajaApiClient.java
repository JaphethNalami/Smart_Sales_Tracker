package com.example.smartsalestracker.Services;

import java.util.concurrent.TimeUnit;

import com.example.smartsalestracker.Interceptor.AccessTokenInterceptor;
import com.example.smartsalestracker.Interceptor.AuthInterceptor;
import okhttp3.OkHttpClient;
import okhttp3.logging.HttpLoggingInterceptor;
import retrofit2.Retrofit;
import retrofit2.converter.gson.GsonConverterFactory;

import static com.example.smartsalestracker.Constants.BASE_URL;
import static com.example.smartsalestracker.Constants.CONNECT_TIMEOUT;
import static com.example.smartsalestracker.Constants.READ_TIMEOUT;
import static com.example.smartsalestracker.Constants.WRITE_TIMEOUT;
